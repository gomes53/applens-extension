...
function getInfoFromDFM(selection) {
  ...
  var statement = ""
  try {
    statement = document.getElementById("id-f69cd9eb-34c1-4fc3-ae74-34be2c2dde2d-1-msdfm_customerstatemente0dece4b-6fc8-4a8f-a065-082708572369-msdfm_caserestrictedattributesid.msdfm_customerstatement.fieldControl-text-box-text").value;
